...
| **20** | **Database Manager native** — MySQL/MariaDB + PostgreSQL via SSH tunnel (browse · SQL editor · edit/insert/delete · export/import `.sql`) | 🎯 **pre-rilis 14** · 🟡 **20A ✅** (MVP: konek·SQL·browse·autocomplete·tipe ramah; uji native ✅ s/d 20A-4) · **20B ✅** (20B-1 Structure uji native ✅ · 20B-2 edit/insert/delete uji native pending). Sisa 20C (export/import) · 20D (Postgres) ⬜ (lihat **§19**) |
