...
// Release signing. Credentials live in `keystore.properties` (gitignored) so
// nothing secret is committed. Create it from keystore.properties.example.
...
android {
    compileSdk = 36
    namespace = "com.moorix.app"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "com.moorix.app"
        minSdk = 24
        targetSdk = 36
